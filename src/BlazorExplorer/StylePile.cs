...
namespace BlazorUI
{
    ...
    public class StylePile : List<StyleElem>
    {
        ...
        public StylePile Add(StylePile other)
        {
            if (other != null)
        ...
        public StylePile Add(string elemInit)
        {
            if (elemInit == null)
                return this;
        ...
        public StylePile Add(string key, string value, bool doNotSetIfNull = false)
        {
        ...
        public StylePile Set(string key, string value,
            bool add = false,
        ...
        public StylePile Set(StyleElem elem,
            bool add = false,
            bool doNotSetIfNull = false)
        {
            if (elem == null)
        ...
        public StylePile Remove(string key)
        {
        ...
        public static double FontSizeRelToFit(string text, int normLen)
        {
            if (text == null || text.Length <= normLen || normLen < 2)
                return 1.0;

            var res = 1.0 * normLen / text.Length;

            // underestimates a bit
            res = Math.Min(1.0, 1.2 * res);

            return res;
        }

        public StylePile SetSpecifics(
