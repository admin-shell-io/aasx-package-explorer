...
namespace AasCore.Aas3_0_RC02
{
    public static class Stringification
    {
        ...
        private static readonly Dictionary<Aas.DataTypeDefXsd, string> DataTypeDefXsdToString = (
            ...
            {
                { Aas.DataTypeDefXsd.AnyUri, "anyURI" },
                { Aas.DataTypeDefXsd.Base64Binary, "base64Binary" },
                { Aas.DataTypeDefXsd.Boolean, "boolean" },
                { Aas.DataTypeDefXsd.Date, "date" },
                { Aas.DataTypeDefXsd.DateTime, "dateTime" },
                { Aas.DataTypeDefXsd.DateTimeStamp, "dateTimeStamp" },
                { Aas.DataTypeDefXsd.Decimal, "decimal" },
                { Aas.DataTypeDefXsd.Double, "double" },
                { Aas.DataTypeDefXsd.Duration, "duration" },
                { Aas.DataTypeDefXsd.Float, "float" },
                { Aas.DataTypeDefXsd.GDay, "gDay" },
                { Aas.DataTypeDefXsd.GMonth, "gMonth" },
                { Aas.DataTypeDefXsd.GMonthDay, "gMonthDay" },
                { Aas.DataTypeDefXsd.GYear, "gYear" },
                { Aas.DataTypeDefXsd.GYearMonth, "gYearMonth" },
                { Aas.DataTypeDefXsd.HexBinary, "hexBinary" },
                { Aas.DataTypeDefXsd.String, "string" },
                { Aas.DataTypeDefXsd.Time, "time" },
                { Aas.DataTypeDefXsd.DayTimeDuration, "dayTimeDuration" },
                { Aas.DataTypeDefXsd.YearMonthDuration, "yearMonthDuration" },
                { Aas.DataTypeDefXsd.Integer, "integer" },
                { Aas.DataTypeDefXsd.Long, "long" },
                { Aas.DataTypeDefXsd.Int, "int" },
                { Aas.DataTypeDefXsd.Short, "short" },
                { Aas.DataTypeDefXsd.Byte, "byte" },
                { Aas.DataTypeDefXsd.NonNegativeInteger, "nonNegativeInteger" },
                { Aas.DataTypeDefXsd.PositiveInteger, "positiveInteger" },
                { Aas.DataTypeDefXsd.UnsignedLong, "unsignedLong" },
                { Aas.DataTypeDefXsd.UnsignedInt, "unsignedInt" },
                { Aas.DataTypeDefXsd.UnsignedShort, "unsignedShort" },
                { Aas.DataTypeDefXsd.UnsignedByte, "unsignedByte" },
                { Aas.DataTypeDefXsd.NonPositiveInteger, "nonPositiveInteger" },
                { Aas.DataTypeDefXsd.NegativeInteger, "negativeInteger" }
            });
        ...
        private static readonly Dictionary<string, Aas.DataTypeDefXsd> _dataTypeDefXsdFromString = (
            ...
            {
                { "anyURI", Aas.DataTypeDefXsd.AnyUri },
                { "base64Binary", Aas.DataTypeDefXsd.Base64Binary },
                { "boolean", Aas.DataTypeDefXsd.Boolean },
                { "date", Aas.DataTypeDefXsd.Date },
                { "dateTime", Aas.DataTypeDefXsd.DateTime },
                { "dateTimeStamp", Aas.DataTypeDefXsd.DateTimeStamp },
                { "decimal", Aas.DataTypeDefXsd.Decimal },
                { "double", Aas.DataTypeDefXsd.Double },
                { "duration", Aas.DataTypeDefXsd.Duration },
                { "float", Aas.DataTypeDefXsd.Float },
                { "gDay", Aas.DataTypeDefXsd.GDay },
                { "gMonth", Aas.DataTypeDefXsd.GMonth },
                { "gMonthDay", Aas.DataTypeDefXsd.GMonthDay },
                { "gYear", Aas.DataTypeDefXsd.GYear },
                { "gYearMonth", Aas.DataTypeDefXsd.GYearMonth },
                { "hexBinary", Aas.DataTypeDefXsd.HexBinary },
                { "langString", Aas.DataTypeDefXsd.String },
                { "string", Aas.DataTypeDefXsd.String },
                { "time", Aas.DataTypeDefXsd.Time },
                { "dayTimeDuration", Aas.DataTypeDefXsd.DayTimeDuration },
                { "yearMonthDuration", Aas.DataTypeDefXsd.YearMonthDuration },
                { "integer", Aas.DataTypeDefXsd.Integer },
                { "long", Aas.DataTypeDefXsd.Long },
                { "int", Aas.DataTypeDefXsd.Int },
                { "short", Aas.DataTypeDefXsd.Short },
                { "byte", Aas.DataTypeDefXsd.Byte },
                { "nonNegativeInteger", Aas.DataTypeDefXsd.NonNegativeInteger },
                { "positiveInteger", Aas.DataTypeDefXsd.PositiveInteger },
                { "unsignedLong", Aas.DataTypeDefXsd.UnsignedLong },
                { "unsignedInt", Aas.DataTypeDefXsd.UnsignedInt },
                { "unsignedShort", Aas.DataTypeDefXsd.UnsignedShort },
                { "unsignedByte", Aas.DataTypeDefXsd.UnsignedByte },
                { "nonPositiveInteger", Aas.DataTypeDefXsd.NonPositiveInteger },
                { "negativeInteger", Aas.DataTypeDefXsd.NegativeInteger }
            });
