...
namespace AasxPredefinedConcepts.Convert
{
    public class ConvertNameplateHsuToZveiV10Provider : ConvertProviderBase
    {
                ...
                ConvertOfferBase offerBase, bool deleteOldCDs, bool addNewCDs)
        {
            ...
            sm.SemanticId = new Aas.Reference(Aas.ReferenceTypes.ModelReference, new List<Aas.IKey>() { defsV10.SM_Nameplate.SemanticId.GetAsExactlyOneKey() });
            ...
            sm.SubmodelElements.CopyOneSMEbyCopy<Aas.Property>(defsV10.CD_ManNam,
                smHSU, defsHSU.CD_ManufacturerName,
                createDefault: true, addSme: true, idShort: "ManufacturerName");

            sm.SubmodelElements.CopyOneSMEbyCopy<Aas.Property>(defsV10.CD_ManProDes,
            ...
            foreach (var smcHSUadd in smHSU.FindAllSemanticIdAs<Aas.SubmodelElementCollection>(
                        defsHSU.CD_PhysicalAddress.GetSingleKey()))
            {
                // make a new one
                var smcV10add = sm.SubmodelElements.CreateSMEForCD<Aas.SubmodelElementCollection>(
                                defsV10.CD_Add, idShort: "Address", addSme: true);

                // SME
                smcV10add.Value.CopyOneSMEbyCopy<Aas.Property>(defsV10.CD_Str,
                    smcHSUadd.Value, new[] {
                ...
                smcV10add.Value.CopyOneSMEbyCopy<Aas.Property>(defsV10.CD_ZipCod,
                    smcHSUadd.Value, new[] {
                ...
                smcV10add.Value.CopyOneSMEbyCopy<Aas.Property>(defsV10.CD_CitTow,
                    smcHSUadd.Value, new[] {
                ...
                smcV10add.Value.CopyOneSMEbyCopy<Aas.Property>(defsV10.CD_StaCou,
                    smcHSUadd.Value, new[] {
                ...
                smcV10add.Value.CopyOneSMEbyCopy<Aas.Property>(defsV10.CD_NatCod,
            ...
            sm.SubmodelElements.CopyOneSMEbyCopy<Aas.Property>(defsV10.CD_ManProFam,
                smHSU, defsHSU.CD_ManufacturerProductFamily,
                createDefault: true, addSme: true, idShort: "ManufacturerProductFamily");

            sm.SubmodelElements.CopyOneSMEbyCopy<Aas.Property>(defsV10.CD_SerNum,
                smHSU, defsHSU.CD_SerialNumber,
                createDefault: true, addSme: true, idShort: "SerialNumber");

            sm.SubmodelElements.CopyOneSMEbyCopy<Aas.Property>(defsV10.CD_YeaOfCon,
                smHSU, defsHSU.CD_YearOfConstruction,
                createDefault: true, addSme: true, idShort: "YearOfConstruction");

            // Markings 
            var smcV10mks = sm.SubmodelElements.CreateSMEForCD<Aas.SubmodelElementCollection>(
                            defsV10.CD_Markings, idShort: "Markings", addSme: true);

            // each Marking
            foreach (var smcHSUmk in smHSU.FindAllSemanticIdAs<Aas.SubmodelElementCollection>(
                        defsHSU.CD_ProductMarking.GetSingleKey()))
            {
                // make a new one
                var smcV10mk = smcV10mks.Value.CreateSMEForCD<Aas.SubmodelElementCollection>(
                ...
                var mkNameProp = smcV10mk.Value.CreateSMEForCD<Aas.Property>(
                                    defsV10.CD_MarkingName, idShort: "MarkingName", addSme: true);
                mkNameProp.Value = "" + mkName;

                // file
                smcV10mk.Value.CopyOneSMEbyCopy<Aas.File>(defsV10.CD_MarkingFile,
                ...
                foreach (var other in smcHSUmk.Value.FindAll((smw) => smw is Aas.Property))
                    if (mkNameProp != null
