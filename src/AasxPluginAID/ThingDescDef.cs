...
namespace AasxPluginAID
{
    class ThingDescDef
    {
        public static JObject semanticIDJObject = new JObject
        {
            ...
            ["InterfaceDescription"] = "https://admin-shell.io/1/0/InterfaceDescription",
            ["EndpointMetadata"] = "https://admin-shell.io/1/0/EndpointMetadata",
            ["InterfaceMetaData"] = "https://admin-shell.io/1/0/InterfaceMetaData",
            ...
            ["scheme"] = "https://www.w3.org/2019/wot/td#scheme",
