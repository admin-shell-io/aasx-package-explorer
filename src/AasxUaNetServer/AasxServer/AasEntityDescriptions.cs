    ...
    public class AasEntityDescriptions
    {
        ...
        static AasEntityDescriptions()
        {
            ...
            AddDescription("AAS:Submodel",
				...
				Each submodel refers to a well-defined domain or subject matter. Submodels can become standardized and thus become submodels types. Submodels can have different life-cycles. ");
            ...
            AddDescription("AAS:Referable",
                @"An element that is referable but has no globally unique. The id of the element is unique within the name space of the element.");
