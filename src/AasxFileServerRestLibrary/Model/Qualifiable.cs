...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Qualifiable : IEquatable<Qualifiable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Qualifiable" /> class.
        /// </summary>
        /// <param name="qualifiers">qualifiers.</param>
        public Qualifiable(List<Constraint> qualifiers = default(List<Constraint>))
        {
        ...
        {
            return this.Equals(input as Qualifiable);
        }

        /// <summary>
        /// Returns true if Qualifiable instances are equal
        /// </summary>
        /// <param name="input">Instance of Qualifiable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Qualifiable input)
        {
            if (input == null)
                return false;
