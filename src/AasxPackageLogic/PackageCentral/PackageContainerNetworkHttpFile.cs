    ...
    public class PackageContainerNetworkHttpFile : PackageContainerBuffered
    {
            ...
            PackCntRuntimeOptions runtimeOptions = null)
        {
            ...
            while (repeat)
            {
                ...
                {
                    Log.Singleton.Error("DownloadFromSource Server gave: AasCore.Aas3_0_RC02.Operation not allowed!");
            ...
            PackCntRuntimeOptions runtimeOptions = null)
        {
            ...
            using (var response = await client.PutAsync(requestPath, data))
            {
                ...
                if (!response.IsSuccessStatusCode)
                {
                    Log.Singleton.Error("UploadToServerAsync Server gave: AasCore.Aas3_0_RC02.Operation not allowed!");
                    throw new PackageContainerException($"Server operation not allowed!");
                }
            }
        }
