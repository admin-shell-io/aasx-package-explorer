...
namespace AasxImport.Cdd
{
    ...
    public abstract class Element
    {
        ...
        private List<string> GetList(string key)
        {
            ...
            // TODO: Why do some fields use {, others (?  How should we handle this properly?
    ...
    public class Class : Element
    {
        ...
        public ReferenceList<Property> GetAllProperties(Context context)
        {
            ...
            if (superclass != null)
            {
                // TODO: circles in class hierarchy?
    ...
    {
        // TODO: investigate CONSTRAINED_SET
        ...
        public static AggregateType? ParseType(string typeName, string[] typeArgs, DataType subtype)
        {
            ...
            // TODO: handle extra arguments for CONSTRAINED_SET
