...
namespace AasxCompatibilityModels
{
    ...
    public class XmlValidatorV20
    {
        ...
        internal XmlValidatorV20(XmlSchemaSet xmlSchemaSet)
        {
        ...
        public void Validate(AasValidationRecordListV20 recs, Stream xmlContent)
        {
            if (recs == null)
            ...
            settings.ValidationEventHandler +=
                ...
                {
                    recs.Add(
                        new AasValidationRecordV20(
                            AasValidationSeverityV20.Serialization, null,
    ...
    public enum AasValidationSeverityV20
    {
        Hint, Warning, SpecViolation, SchemaViolation, Serialization
    }

    [UsedImplicitlyAttribute] // for eventual use
    public enum AasValidationActionV20
    {
        No, ToBeDeleted
    }

    public class AasValidationRecordV20
    {
        public AasValidationSeverityV20 Severity = AasValidationSeverityV20.Hint;
        public AdminShellV20.Referable Source = null;
        public string Message = "";

        public Action Fix = null;

        public AasValidationRecordV20(AasValidationSeverityV20 Severity, AdminShellV20.Referable Source,
    ...
    public class AasValidationRecordListV20 : List<AasValidationRecordV20>
    {
    }

    public static class AasSchemaValidationV20
    {
        ...
        public static XmlValidatorV20 NewXmlValidator()
        {
            ...
            var newRecs = new AasValidationRecordListV20();
            ...
            if (newRecs.Count > 0)
            {
                ...
                parts.AddRange(newRecs.Select<AasValidationRecordV20, string>((r) => r.Message));
        ...
        public static int ValidateJSONAlternative(AasValidationRecordListV20 recs, Stream jsonContent)
        {
            ...
            if (errors != null)
                foreach (var ve in errors)
                {
                    ...
                    newRecs.Add(new AasValidationRecordV20(AasValidationSeverityV20.Serialization, null,
