...
namespace IO.Swagger.Client
{
        ...
        public class Configuration : IReadableConfiguration
    {
        ...
        public Configuration(
            ...
            int timeout = 100000,
            string userAgent = "AASRestClient"
        ...
        public virtual ApiClient ApiClient
        {
            get
            {
                if (_apiClient == null) _apiClient = CreateApiClient(HttpClient);
                return _apiClient;
            }
        }
        ...
        {
            return new ApiClient() { Configuration = this};
        }

        public ApiClient CreateApiClient(HttpClient httpClient)
        {
            return new ApiClient(httpClient) { Configuration = this };
        }
        ...
        public static String ToDebugReport()
        {
            ...
            report += "    Version of the API: Final-Draft\n";
