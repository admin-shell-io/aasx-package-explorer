...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SubmodelElement : Referable,  IEquatable<SubmodelElement>, IValidatableObject
    {
        /// <summary>
        ...
        public SubmodelElement(List<EmbeddedDataSpecification> embeddedDataSpecifications = default(List<EmbeddedDataSpecification>), Reference semanticId = default(Reference), List<Constraint> qualifiers = default(List<Constraint>), ModelingKind kind = default(ModelingKind), string category = default(string), List<LangString> description = default(List<LangString>), List<LangString> displayName = default(List<LangString>), string idShort = default(string), ModelType modelType = default(ModelType)) : base(category, description, displayName, idShort, modelType)
        {
        ...
        {
            return this.Equals(input as SubmodelElement);
        }

        /// <summary>
        /// Returns true if SubmodelElement instances are equal
        /// </summary>
        /// <param name="input">Instance of SubmodelElement to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubmodelElement input)
        {
            if (input == null)
                return false;
