...
namespace IO.Swagger.Model
{
        ...
        public partial class AssetAdministrationShell : Identifiable,  IEquatable<AssetAdministrationShell>, IValidatableObject
    {
        ...
        public AssetAdministrationShell(List<EmbeddedDataSpecification> embeddedDataSpecifications = default(List<EmbeddedDataSpecification>), AssetInformation assetInformation = default(AssetInformation), Reference derivedFrom = default(Reference), Security security = default(Security), List<Reference> submodels = default(List<Reference>), List<View> views = default(List<View>), AdministrativeInformation administration = default(AdministrativeInformation), string identification = default(string)) : base(administration, identification)
        {
